...
<a id="loadMore_2">Загрузить еще</a>
...
<script>
	var box2 = document.querySelectorAll('.gallery_2 .seoven_gallery_element');
	var btn2 = document.getElementById('loadMore_2');
	for (let i = 11; i < box2.length; i++) {
